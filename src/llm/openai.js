...
export async function generateOpenAIDigest(articles, lang, opts = {}) {
  const log = getLogger();
  ...
  log.info(`OpenAI digest generated for ${lang} (${markdown.length} chars)`);
